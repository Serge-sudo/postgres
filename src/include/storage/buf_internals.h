 ...
 *
 * - 17 bits refcount (reduced from 18 to make room for BM_HOT flag)
 * - 4 bits usage count
 * - 11 bits of flags
 *
 ...
 */
#define BM_HOT					(1U << 21)	/* buffer is permanently pinned (hot) */
...
/*
 * Hot buffer tracking structures
 *
 * HotBufferBitmap tracks which backends have references to hot buffers.
...
extern PGDLLIMPORT HotBufferControl *HotBufferBitmap;
