...
PG_CMDTAG(CMDTAG_ALTER_SHARD_GROUP, "ALTER SHARD GROUP", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_SHARD_GROUP, "CREATE SHARD GROUP", true, false, false)
PG_CMDTAG(CMDTAG_DROP_SHARD_GROUP, "DROP SHARD GROUP", true, false, false)
