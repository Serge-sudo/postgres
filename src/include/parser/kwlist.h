...
PG_KEYWORD("member", MEMBER, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("reshard", RESHARD, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("worldwide", WORLDWIDE, UNRESERVED_KEYWORD, BARE_LABEL)
